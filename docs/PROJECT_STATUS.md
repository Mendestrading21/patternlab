...
- Prochain : **V5 Lot 7 — Leçons V5** (visual-first : hook → observation → hypothèse → manipulation → faux signal → flashcard) ou **Lot 8 — Parcours & 15 mondes**, poursuite lot par lot.
